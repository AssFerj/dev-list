export const devs = [
    {
        devs: [
            {
                id: 1,
                email: 'assis@mail.com',
                password: '123456',
                name: 'Assis Junior',
                banner: 'https://images.unsplash.com/photo-1515704089429-fd06e6668458?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80',
                foto: 'https://th.bing.com/th/id/OIP.XSZAFm-5JI7nriDLwZqRQQHaE7?pid=ImgDet&rs=1',
                age: 36,
                description: 'Aluno da 12ª edição do curso de Desenvolvimento Web Fullstack da Growdev',
                stack: ['FullStack'],
                hardSkills: ['HTML', 'CSS', 'Javascript', 'Typescript', 'Bootstrap', 'React', 'Redux', 'NodeJs', 'Express'],
                softSkills: []
            },
            {
                id: 2,
